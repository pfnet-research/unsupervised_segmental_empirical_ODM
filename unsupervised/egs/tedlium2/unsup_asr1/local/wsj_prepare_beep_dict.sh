...
tr '[:lower:]' '[:upper:]' < ${TEDLIUM_DIR}/TEDLIUM_release2/TEDLIUM.152k.dic > ${dir}/tedlium.dict
...
perl local/merge_dict.pl $dir/beep_cmu.dict ${dir}/tedlium.dict ${dir}/multidataset.dict
...
grep -v "^#" $dir/${USE_DICT} > $dir/lexicon1_raw_nosil.txt
...
(echo -e '!SIL\tSIL'; echo -e '<SPOKEN_NOISE>\tSPN'; echo -e '<UNK>\tSPN'; echo -e '<NOISE>\tNSN'; ) | \
