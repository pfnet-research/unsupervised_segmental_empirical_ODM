...
def train(args):
    ...
    unk = args.char_list_dict[args.unk_val]
    eos = args.char_list_dict['<eos>']
    # read tokens as a sequence of sentences
    train = read_tokens(args.train_label, args.char_list_dict, unk=args.unk_val)
    val = read_tokens(args.valid_label, args.char_list_dict, unk=args.unk_val)
    # count tokens
