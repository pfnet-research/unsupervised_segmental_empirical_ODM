...
def main(cmd_args):
    ...
    if args.fully_unsupervised:
        ...
        from espnet.asr.chainer_backend.fully_unsup_asr import train
    elif args.unsupervised:
        logging.info('Unsupervised')
        from espnet.asr.chainer_backend.u_asr import train
    elif args.boundary:
        logging.info('Boundary')
        from espnet.asr.chainer_backend.boundary import train
    elif args.pretrain:
        logging.info('Pretrain')
        from espnet.asr.chainer_backend.pre_asr import train
    else:
        if args.num_spkrs == 1:
